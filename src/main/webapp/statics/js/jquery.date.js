	...
	return {
		...
		adjust: function( period, offset ) {
			var day = period == "D" ? date.getDate() + offset : date.getDate(), 
				...
				hour = period == "H" ? date.getHours() + offset : date.getHours();
				minute = period == "m" ? date.getMinutes() + offset : date.getMinutes();
				second = period == "S" ? date.getSeconds() + offset : date.getSeconds();
